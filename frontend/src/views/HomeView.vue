...
// normalize - добавляют новые ключи value c названиями из data
...
const price = computed(() => {
  ...
  console.log('<HomeView> pizza',pizza);

  // ищем item по значению у устанавливаем модификатор/цену
...
// Есть цена и название то разблокируем кнопку Готово
...
// устанавливаем новое количество ингредиентов
